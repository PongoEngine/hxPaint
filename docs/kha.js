...
var hxPaint_Box = function(solver) {
	...
	this.y = this11;
	var this12 = new jasper__$Variable_$("");
	this.width = this12;
...
hxPaint_Button.prototype = $extend(hxPaint_Box.prototype,{
	onAdded: function() {
		...
		if(this.prev == null) {
			...
			var this12 = this.solver;
			var _g21 = this.y;
			var _g31 = jasper__$Expression_Expression_$Impl_$.addValue(jasper__$Variable_Variable_$Impl_$.addVariable(this.prev.y,this.prev.height),5);
			this12.addConstraint(jasper__$Expression_Expression_$Impl_$.equalsVariable(_g31,_g21));
		}
		var this13 = this.solver;
		var _g22 = this.width;
		var _g32 = jasper__$Variable_Variable_$Impl_$.subtractValue(this.parent.width,10);
		this13.addConstraint(jasper__$Expression_Expression_$Impl_$.equalsVariable(_g32,_g22));
		var this14 = this.solver;
		var _g4 = this.height;
		var _g5 = jasper__$Variable_Variable_$Impl_$.subtractValue(this.parent.width,10);
		this14.addConstraint(jasper__$Expression_Expression_$Impl_$.equalsVariable(_g5,_g4));
...
hxPaint_LeftPanel.prototype = $extend(hxPaint_Box.prototype,{
	onAdded: function() {
		...
		this12.addConstraint(jasper__$Expression_Expression_$Impl_$.equalsVariable(_g5,_g4));
...
$hxClasses["jasper._Constraint_"] = jasper__$Constraint_$;
jasper__$Constraint_$.__name__ = true;
jasper__$Constraint_$.fromConstraint = function(other,strength) {
	strength = jasper__$Strength_Strength_$Impl_$.clip(strength);
	return new jasper__$Constraint_$(other.m_expression,other.m_op,strength);
};
jasper__$Constraint_$.fromExpression = function(expr,op,strength) {
	expr = jasper__$Constraint_$.reduce(expr);
	strength = jasper__$Strength_Strength_$Impl_$.clip(strength);
	return new jasper__$Constraint_$(expr,op,strength);
};
jasper__$Constraint_$.reduce = function(expr) {
	var this1 = new jasper_ds_JasperMap();
	var vars = this1;
	var _g = 0;
	var _g1 = expr.m_terms;
	while(_g < _g1.length) {
		var term = _g1[_g];
		++_g;
		var _g2 = term.m_variable;
		var _g3 = vars;
		var v = (_g3._map.exists(_g2) ? _g3._map.get(_g2) : 0) + term.m_coefficient;
		if(!_g3._map.exists(_g2)) {
			_g3._keys.push(_g2);
		}
		_g3._map.set(_g2,v);
	}
	var _g4 = [];
	var key = HxOverrides.iter(vars._keys);
	while(key.hasNext()) {
		var key1 = key.next();
		var this2 = new jasper__$Term_$(key1,vars._map.exists(key1) ? vars._map.get(key1) : 0);
		_g4.push(this2);
	}
	var terms = _g4;
	var this3 = new jasper__$Expression_$(terms,expr.m_constant);
	return this3;
};
...
var jasper_RelationalOperator = $hxClasses["jasper.RelationalOperator"] = { __ename__ : true, __constructs__ : ["OP_LE","OP_GE","OP_EQ"] };
jasper_RelationalOperator.OP_LE = ["OP_LE",0];
jasper_RelationalOperator.OP_LE.toString = $estr;
jasper_RelationalOperator.OP_LE.__enum__ = jasper_RelationalOperator;
jasper_RelationalOperator.OP_GE = ["OP_GE",1];
jasper_RelationalOperator.OP_GE.toString = $estr;
jasper_RelationalOperator.OP_GE.__enum__ = jasper_RelationalOperator;
jasper_RelationalOperator.OP_EQ = ["OP_EQ",2];
jasper_RelationalOperator.OP_EQ.toString = $estr;
jasper_RelationalOperator.OP_EQ.__enum__ = jasper_RelationalOperator;
var jasper__$Constraint_Constraint_$Impl_$ = {};
$hxClasses["jasper._Constraint.Constraint_Impl_"] = jasper__$Constraint_Constraint_$Impl_$;
jasper__$Constraint_Constraint_$Impl_$.__name__ = true;
jasper__$Constraint_Constraint_$Impl_$._new = function(expr,op,strength) {
	if(strength == null) {
		strength = 1001001000;
	}
	var this1 = jasper__$Constraint_$.fromExpression(expr,op,strength);
	return this1;
};
jasper__$Constraint_Constraint_$Impl_$.modifyStrength = function(constraint,strength) {
	return jasper__$Constraint_$.fromConstraint(constraint,strength);
};
var jasper_UnsatisfiableConstraint = function(constraint) {
	haxe_Log.trace("UnsatisfiableConstraint: " + Std.string(constraint),{ fileName : "Errors.hx", lineNumber : 16, className : "jasper.UnsatisfiableConstraint", methodName : "new"});
};
$hxClasses["jasper.UnsatisfiableConstraint"] = jasper_UnsatisfiableConstraint;
jasper_UnsatisfiableConstraint.__name__ = true;
jasper_UnsatisfiableConstraint.prototype = {
	__class__: jasper_UnsatisfiableConstraint
};
var jasper_UnknownConstraint = function(constraint) {
	haxe_Log.trace("UnknownConstraint: " + Std.string(constraint),{ fileName : "Errors.hx", lineNumber : 24, className : "jasper.UnknownConstraint", methodName : "new"});
};
$hxClasses["jasper.UnknownConstraint"] = jasper_UnknownConstraint;
jasper_UnknownConstraint.__name__ = true;
jasper_UnknownConstraint.prototype = {
	__class__: jasper_UnknownConstraint
};
var jasper_DuplicateConstraint = function(constraint) {
	haxe_Log.trace("DuplicateConstraint: " + Std.string(constraint),{ fileName : "Errors.hx", lineNumber : 32, className : "jasper.DuplicateConstraint", methodName : "new"});
};
$hxClasses["jasper.DuplicateConstraint"] = jasper_DuplicateConstraint;
jasper_DuplicateConstraint.__name__ = true;
jasper_DuplicateConstraint.prototype = {
	__class__: jasper_DuplicateConstraint
};
var jasper_UnknownEditVariable = function(variable) {
	haxe_Log.trace("UnknownEditVariable: " + Std.string(variable),{ fileName : "Errors.hx", lineNumber : 40, className : "jasper.UnknownEditVariable", methodName : "new"});
};
$hxClasses["jasper.UnknownEditVariable"] = jasper_UnknownEditVariable;
jasper_UnknownEditVariable.__name__ = true;
jasper_UnknownEditVariable.prototype = {
	__class__: jasper_UnknownEditVariable
};
var jasper_DuplicateEditVariable = function(variable) {
	haxe_Log.trace("DuplicateEditVariable: " + Std.string(variable),{ fileName : "Errors.hx", lineNumber : 48, className : "jasper.DuplicateEditVariable", methodName : "new"});
};
$hxClasses["jasper.DuplicateEditVariable"] = jasper_DuplicateEditVariable;
jasper_DuplicateEditVariable.__name__ = true;
jasper_DuplicateEditVariable.prototype = {
	__class__: jasper_DuplicateEditVariable
};
var jasper_BadRequiredStrength = function() {
	haxe_Log.trace("BadRequiredStrength",{ fileName : "Errors.hx", lineNumber : 56, className : "jasper.BadRequiredStrength", methodName : "new"});
};
$hxClasses["jasper.BadRequiredStrength"] = jasper_BadRequiredStrength;
jasper_BadRequiredStrength.__name__ = true;
jasper_BadRequiredStrength.prototype = {
	__class__: jasper_BadRequiredStrength
};
var jasper_InternalSolverError = function(message) {
	haxe_Log.trace("InternalSolverError: " + message,{ fileName : "Errors.hx", lineNumber : 64, className : "jasper.InternalSolverError", methodName : "new"});
};
$hxClasses["jasper.InternalSolverError"] = jasper_InternalSolverError;
jasper_InternalSolverError.__name__ = true;
jasper_InternalSolverError.prototype = {
	__class__: jasper_InternalSolverError
};
var jasper__$Expression_$ = function(terms,constant) {
	this.m_terms = terms;
...
jasper__$Expression_$.prototype = {
	...
	,__class__: jasper__$Expression_$
};
var jasper__$Expression_Expression_$Impl_$ = {};
$hxClasses["jasper._Expression.Expression_Impl_"] = jasper__$Expression_Expression_$Impl_$;
jasper__$Expression_Expression_$Impl_$.__name__ = true;
jasper__$Expression_Expression_$Impl_$._new = function(terms,constant) {
	if(constant == null) {
		constant = 0.0;
	}
	var this1 = new jasper__$Expression_$(terms,constant);
	return this1;
};
jasper__$Expression_Expression_$Impl_$.multiplyValue = function(expression,coefficient) {
	var terms = [];
	var _g = 0;
	var _g1 = expression.m_terms;
	while(_g < _g1.length) {
		var term = _g1[_g];
		++_g;
		terms.push(jasper__$Term_Term_$Impl_$.multiplyValue(term,coefficient));
	}
	var this1 = new jasper__$Expression_$(terms,expression.m_constant * coefficient);
	return this1;
};
jasper__$Expression_Expression_$Impl_$.divideValue = function(expression,denominator) {
	return jasper__$Expression_Expression_$Impl_$.multiplyValue(expression,1.0 / denominator);
};
jasper__$Expression_Expression_$Impl_$.negateExpression = function(expression) {
	return jasper__$Expression_Expression_$Impl_$.multiplyValue(expression,-1.0);
};
jasper__$Expression_Expression_$Impl_$.addExpression = function(first,second) {
	var terms = [];
	var _g = 0;
	var _g1 = first.m_terms;
	while(_g < _g1.length) {
		var t = _g1[_g];
		++_g;
		terms.push(t);
	...
	var _g2 = 0;
	var _g11 = second.m_terms;
	while(_g2 < _g11.length) {
		var t1 = _g11[_g2];
		++_g2;
		terms.push(t1);
	}
	var this1 = new jasper__$Expression_$(terms,first.m_constant + second.m_constant);
	return this1;
};
jasper__$Expression_Expression_$Impl_$.addTerm = function(first,second) {
	var terms = [];
	var _g = 0;
	var _g1 = first.m_terms;
	while(_g < _g1.length) {
	...
	terms.push(second);
	var this1 = new jasper__$Expression_$(terms,first.m_constant);
	return this1;
};
jasper__$Expression_Expression_$Impl_$.addVariable = function(expression,variable) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Expression_Expression_$Impl_$.addTerm(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.addValue = function(expression,constant) {
	var this1 = new jasper__$Expression_$(expression.m_terms,expression.m_constant + constant);
	return this1;
};
jasper__$Expression_Expression_$Impl_$.subtractExpression = function(first,second) {
	return jasper__$Expression_Expression_$Impl_$.addExpression(first,jasper__$Expression_Expression_$Impl_$.negateExpression(second));
};
jasper__$Expression_Expression_$Impl_$.subtractTerm = function(expression,term) {
	return jasper__$Expression_Expression_$Impl_$.addTerm(expression,jasper__$Term_Term_$Impl_$.negateTerm(term));
};
jasper__$Expression_Expression_$Impl_$.subtractVariable = function(expression,variable) {
	return jasper__$Expression_Expression_$Impl_$.addTerm(expression,jasper__$Variable_Variable_$Impl_$.negateVariable(variable));
};
jasper__$Expression_Expression_$Impl_$.subtractValue = function(expression,constant) {
	return jasper__$Expression_Expression_$Impl_$.addValue(expression,-constant);
};
jasper__$Expression_Expression_$Impl_$.equalsExpression = function(first,second) {
	return jasper__$Constraint_Constraint_$Impl_$._new(jasper__$Expression_Expression_$Impl_$.subtractExpression(first,second),jasper_RelationalOperator.OP_EQ);
};
jasper__$Expression_Expression_$Impl_$.equalsTerm = function(expression,term) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.equalsExpression(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.equalsVariable = function(expression,variable) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Expression_Expression_$Impl_$.equalsTerm(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.equalsValue = function(expression,constant) {
	var this1 = new jasper__$Expression_$([],constant);
	return jasper__$Expression_Expression_$Impl_$.equalsExpression(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.lteExpression = function(first,second) {
	return jasper__$Constraint_Constraint_$Impl_$._new(jasper__$Expression_Expression_$Impl_$.subtractExpression(first,second),jasper_RelationalOperator.OP_LE);
};
jasper__$Expression_Expression_$Impl_$.lteTerm = function(expression,term) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.lteExpression(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.lteVariable = function(expression,variable) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Expression_Expression_$Impl_$.lteTerm(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.lteValue = function(expression,constant) {
	var this1 = new jasper__$Expression_$([],constant);
	return jasper__$Expression_Expression_$Impl_$.lteExpression(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.gteExpression = function(first,second) {
	return jasper__$Constraint_Constraint_$Impl_$._new(jasper__$Expression_Expression_$Impl_$.subtractExpression(first,second),jasper_RelationalOperator.OP_GE);
};
jasper__$Expression_Expression_$Impl_$.gteTerm = function(expression,term) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.gteExpression(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.gteVariable = function(expression,variable) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Expression_Expression_$Impl_$.gteTerm(expression,this1);
};
jasper__$Expression_Expression_$Impl_$.gteValue = function(expression,constant) {
	var this1 = new jasper__$Expression_$([],constant);
	return jasper__$Expression_Expression_$Impl_$.gteExpression(expression,this1);
};
var jasper_Row = function(constant) {
	if(constant == null) {
		constant = 0;
	}
	var this1 = new jasper_ds_JasperMap();
...
$hxClasses["jasper.Row"] = jasper_Row;
jasper_Row.__name__ = true;
jasper_Row.fromRow = function(other) {
	var row = new jasper_Row(other.m_constant);
	var it = new jasper_ds__$JasperMap_KeyValIterator(other.m_cells);
	while(it.hasNext()) {
		var it1 = it.next();
		var this1 = row.m_cells;
		var k = it1.first;
		var v = it1.second;
...
jasper_Row.prototype = {
	...
	,insertSymbol: function(symbol,coefficient) {
		...
		var _g = symbol;
		var _g1 = this.m_cells;
		var v = (_g1._map.exists(_g) ? _g1._map.get(_g) : 0) + coefficient;
		if(!_g1._map.exists(_g)) {
			_g1._keys.push(_g);
		}
		_g1._map.set(_g,v);
		if(jasper_Util.nearZero(v)) {
			var _this = this.m_cells;
			if(_this._map.remove(symbol)) {
				HxOverrides.remove(_this._keys,symbol);
			}
		}
	}
	,insertRow: function(other,coefficient) {
		...
		while(it.hasNext()) {
			var it1 = it.next();
			var coeff = it1.second * coefficient;
			var _g = it1.first;
			var _g1 = this.m_cells;
			var v = (_g1._map.exists(_g) ? _g1._map.get(_g) : 0) + coeff;
			if(!_g1._map.exists(_g)) {
				_g1._keys.push(_g);
			}
			_g1._map.set(_g,v);
			if(jasper_Util.nearZero(v)) {
				var _this = this.m_cells;
				var key = it1.first;
				if(_this._map.remove(key)) {
					HxOverrides.remove(_this._keys,key);
				}
			}
		}
	}
	...
	,reverseSign: function() {
		this.m_constant = -this.m_constant;
		var it = new jasper_ds__$JasperMap_KeyValIterator(this.m_cells);
		while(it.hasNext()) {
			var it1 = it.next();
	...
	,solveFor: function(symbol) {
		var this1 = this.m_cells;
		var coeff = -1.0 / (this1._map.exists(symbol) ? this1._map.get(symbol) : 0);
		var _this = this.m_cells;
		if(_this._map.remove(symbol)) {
			HxOverrides.remove(_this._keys,symbol);
		}
	...
	,coefficientFor: function(symbol) {
		var this1 = this.m_cells;
		if(this1._map.exists(symbol)) {
			return this1._map.get(symbol);
		} else {
			return 0;
		}
	}
	...
	,__class__: jasper_Row
};
var jasper__$Solver_Solver_$Impl_$ = {};
$hxClasses["jasper._Solver.Solver_Impl_"] = jasper__$Solver_Solver_$Impl_$;
jasper__$Solver_Solver_$Impl_$.__name__ = true;
jasper__$Solver_Solver_$Impl_$._new = function() {
	var this1 = new jasper_SolverImpl();
	return this1;
};
jasper__$Solver_Solver_$Impl_$.addConstraint = function(this1,constraint) {
	this1.addConstraint(constraint);
};
jasper__$Solver_Solver_$Impl_$.removeConstraint = function(this1,constraint) {
	this1.removeConstraint(constraint);
};
jasper__$Solver_Solver_$Impl_$.hasConstraint = function(this1,constraint) {
	return this1.hasConstraint(constraint);
};
jasper__$Solver_Solver_$Impl_$.addEditVariable = function(this1,variable,strength) {
	this1.addEditVariable(variable,strength);
};
jasper__$Solver_Solver_$Impl_$.removeEditVariable = function(this1,variable) {
	this1.removeEditVariable(variable);
};
jasper__$Solver_Solver_$Impl_$.hasEditVariable = function(this1,variable) {
	return this1.hasEditVariable(variable);
};
jasper__$Solver_Solver_$Impl_$.suggestValue = function(this1,variable,value) {
	this1.suggestValue(variable,value);
};
jasper__$Solver_Solver_$Impl_$.updateVariables = function(this1) {
	this1.updateVariables();
};
jasper__$Solver_Solver_$Impl_$.reset = function(this1) {
	this1.reset();
};
jasper__$Solver_Solver_$Impl_$.dump = function(this1) {
	throw new js__$Boot_HaxeError("dump");
};
var jasper_Tag = function() {
	this.marker = new jasper_Symbol();
	this.other = new jasper_Symbol();
};
...
$hxClasses["jasper.SolverImpl"] = jasper_SolverImpl;
...
jasper_SolverImpl.prototype = {
	addConstraint: function(constraint) {
		...
		var rowptr = this.createRow(constraint,tag);
		var subject = this.chooseSubject(rowptr,tag);
		if(subject.m_type == 0 && this.allDummies(rowptr)) {
			if(!jasper_Util.nearZero(rowptr.m_constant)) {
				throw new js__$Boot_HaxeError(new jasper_UnsatisfiableConstraint(constraint));
			} else {
				subject = tag.marker;
			}
		}
		if(subject.m_type == 0) {
			if(!this.addWithArtificialVariable(rowptr)) {
				throw new js__$Boot_HaxeError(new jasper_UnsatisfiableConstraint(constraint));
			}
		} else {
	...
	,removeConstraint: function(constraint) {
		...
		if(this.m_rows._map.h.__keys__[tag.marker.__id__] != null) {
			var _this1 = this.m_rows;
			var key = tag.marker;
			if(_this1._map.remove(key)) {
				HxOverrides.remove(_this1._keys,key);
			}
		} else {
			var row_it = this.getMarkerLeavingRow(tag.marker);
			if(row_it == null) {
				throw new js__$Boot_HaxeError(new jasper_InternalSolverError("failed to find leaving row"));
			}
			var leaving = row_it.first;
			var rowptr = row_it.second;
			var _this2 = this.m_rows;
			var key1 = row_it.first;
			if(_this2._map.remove(key1)) {
				HxOverrides.remove(_this2._keys,key1);
			}
			rowptr.solveForSymbols(leaving,tag.marker);
			this.substitute(tag.marker,rowptr);
		}
		this.optimize(this.m_objective);
	}
	,hasConstraint: function(constraint) {
		return this.m_cns._map.h.__keys__[constraint.__id__] != null;
	}
	,addEditVariable: function(variable,strength) {
		...
		strength = jasper__$Strength_Strength_$Impl_$.clip(strength);
		if(strength == 1001001000) {
			throw new js__$Boot_HaxeError(new jasper_BadRequiredStrength());
		}
		var this1 = new jasper__$Term_$(variable,1.0);
		var term = this1;
		var this2 = new jasper__$Expression_$([term],0.0);
	...
	,removeEditVariable: function(variable) {
		if(this.m_edits._map.h.__keys__[variable.__id__] == null) {
	...
	,hasEditVariable: function(variable) {
		return this.m_edits._map.h.__keys__[variable.__id__] != null;
	}
	,suggestValue: function(variable,value) {
		...
		var row_it = new jasper_ds__$JasperMap_KeyValIterator(this.m_rows);
		while(row_it.hasNext()) {
			var row_it1 = row_it.next();
			var coeff = row_it1.second.coefficientFor(info.tag.marker);
			if(coeff != 0.0 && row_it1.second.add(delta * coeff) < 0.0 && row_it1.first.m_type != 1) {
				this.m_infeasible_rows.push(row_it1.first);
			}
		}
		this.dualOptimize();
	}
	,updateVariables: function() {
		var var_it = new jasper_ds__$JasperMap_KeyValIterator(this.m_vars);
	...
	,createRow: function(constraint,tag) {
		var expr = constraint.m_expression;
		var row = new jasper_Row(expr.m_constant);
		var _g = 0;
		var _g1 = expr.m_terms;
		while(_g < _g1.length) {
			var term = _g1[_g];
		...
		var _g2 = constraint.m_op;
		switch(_g2[1]) {
		case 0:
			var coeff = 1.0;
			var slack = new jasper_Symbol(2);
			tag.marker = slack;
			row.insertSymbol(slack,coeff);
			if(constraint.m_strength < 1001001000) {
				var error = new jasper_Symbol(3);
				tag.other = error;
				row.insertSymbol(error,-coeff);
				this.m_objective.insertSymbol(error,constraint.m_strength);
			}
			break;
		case 1:
			var coeff1 = -1.0;
			var slack1 = new jasper_Symbol(2);
			tag.marker = slack1;
			row.insertSymbol(slack1,coeff1);
			if(constraint.m_strength < 1001001000) {
				var error1 = new jasper_Symbol(3);
				tag.other = error1;
				row.insertSymbol(error1,-coeff1);
				this.m_objective.insertSymbol(error1,constraint.m_strength);
			}
			break;
		case 2:
			if(constraint.m_strength < 1001001000) {
				var errplus = new jasper_Symbol(3);
				var errminus = new jasper_Symbol(3);
				tag.marker = errplus;
				tag.other = errminus;
				row.insertSymbol(errplus,-1.0);
				row.insertSymbol(errminus,1.0);
				this.m_objective.insertSymbol(errplus,constraint.m_strength);
				this.m_objective.insertSymbol(errminus,constraint.m_strength);
			} else {
				var dummy = new jasper_Symbol(4);
				tag.marker = dummy;
	...
	,chooseSubject: function(row,tag) {
		var it = new jasper_ds__$JasperMap_KeyValIterator(row.m_cells);
		while(it.hasNext()) {
			var it1 = it.next();
			if(it1.first.m_type == 1) {
				return it1.first;
			}
		}
		if(tag.marker.m_type == 2 || tag.marker.m_type == 3) {
			if(row.coefficientFor(tag.marker) < 0.0) {
				return tag.marker;
			}
		}
		if(tag.other.m_type == 2 || tag.other.m_type == 3) {
			if(row.coefficientFor(tag.other) < 0.0) {
				return tag.other;
			}
		}
		return new jasper_Symbol();
	}
	...
	,substitute: function(symbol,row) {
		...
		while(it.hasNext()) {
			var it1 = it.next();
			it1.second.substitute(symbol,row);
			if(it1.first.m_type != 1 && it1.second.m_constant < 0.0) {
				this.m_infeasible_rows.push(it1.first);
			}
		}
		this.m_objective.substitute(symbol,row);
		if(this.m_artificial != null) {
			this.m_artificial.substitute(symbol,row);
		}
	}
	,optimize: function(objective) {
		while(true) {
			...
			var it = this.getLeavingRow(entering);
			if(it == null) {
	...
	,dualOptimize: function() {
		while(this.m_infeasible_rows.length != 0) {
			...
			if(it != null && it.m_constant < 0.0) {
				...
				if(entering.m_type == 0) {
					throw new js__$Boot_HaxeError(new jasper_InternalSolverError("Dual optimize failed."));
				}
				var row = it;
				var _this = this.m_rows;
				if(_this._map.remove(leaving)) {
					HxOverrides.remove(_this._keys,leaving);
				}
	...
	,getEnteringSymbol: function(objective) {
		var it = new jasper_ds__$JasperMap_KeyValIterator(objective.m_cells);
		while(it.hasNext()) {
			var it1 = it.next();
			if(it1.first.m_type != 4 && it1.second < 0.0) {
				return it1.first;
			}
		}
		return new jasper_Symbol();
	}
	,getDualEnteringSymbol: function(row) {
		var entering = null;
		var ratio = 1.79769313486231e+308;
		var it = new jasper_ds__$JasperMap_KeyValIterator(row.m_cells);
		while(it.hasNext()) {
			var it1 = it.next();
			if(it1.second > 0.0 && it1.first.m_type != 4) {
				var coeff = this.m_objective.coefficientFor(it1.first);
				var r = coeff / it1.second;
				if(r < ratio) {
					ratio = r;
					entering = it1.first;
				}
	...
	,anyPivotableSymbol: function(row) {
		...
		while(it.hasNext()) {
			var it1 = it.next();
			if(it1.first.m_type == 2 || it1.first.m_type == 3) {
				return it1.first;
			}
		}
		return new jasper_Symbol();
	...
	,getLeavingRow: function(entering) {
		...
		while(it.hasNext()) {
			var it1 = it.next();
			if(it1.first.m_type != 1) {
				var temp = it1.second.coefficientFor(entering);
				if(temp < 0.0) {
					var temp_ratio = -it1.second.m_constant / temp;
					if(temp_ratio < ratio) {
						ratio = temp_ratio;
						found = it1;
						break;
	...
	,getMarkerLeavingRow: function(marker) {
		var dmax = 1.79769313486231e+308;
		var r1 = dmax;
		var r2 = dmax;
		var end = null;
		var first = end;
		...
		while(it.hasNext()) {
			var it1 = it.next();
			var c = it1.second.coefficientFor(marker);
			if(c == 0.0) {
				continue;
			}
			if(it1.first.m_type == 1) {
				...
				var r = -it1.second.m_constant / c;
				if(r < r1) {
					r1 = r;
					first = it1;
				}
			} else {
				var r3 = it1.second.m_constant / c;
				if(r3 < r2) {
					r2 = r3;
					second = it1;
				}
	...
	,removeConstraintEffects: function(cn,tag) {
		if(tag.marker.m_type == 3) {
			this.removeMarkerEffects(tag.marker,cn.m_strength);
		}
		if(tag.other.m_type == 3) {
			this.removeMarkerEffects(tag.other,cn.m_strength);
		}
	}
	...
	,allDummies: function(row) {
		var it = new jasper_ds__$JasperMap_KeyValIterator(row.m_cells);
		while(it.hasNext()) {
			var it1 = it.next();
			if(it1.first.m_type != 4) {
				return false;
			}
		}
		return true;
...
$hxClasses["jasper._Strength.Strength_Impl_"] = jasper__$Strength_Strength_$Impl_$;
jasper__$Strength_Strength_$Impl_$.__name__ = true;
jasper__$Strength_Strength_$Impl_$._new = function(str) {
	var this1 = str;
	return this1;
};
jasper__$Strength_Strength_$Impl_$.create = function(a,b,c,w) {
	if(w == null) {
		w = 1.0;
	}
	var result = 0.0;
	...
	var this1 = result += Math.max(0.0,Math.min(1000.0,c * w));
	return this1;
};
jasper__$Strength_Strength_$Impl_$.clip = function(value) {
	var this1 = Math.max(0.0,Math.min(1001001000,value));
	return this1;
};
var jasper_Symbol = function(type) {
	if(type == null) {
		type = 0;
	}
	this.m_type = type;
...
jasper__$Term_$.prototype = {
	...
	,toString: function() {
		return "variable: (" + Std.string(this.m_variable) + ") coefficient: " + this.m_coefficient;
	}
	,__class__: jasper__$Term_$
};
var jasper__$Term_Term_$Impl_$ = {};
$hxClasses["jasper._Term.Term_Impl_"] = jasper__$Term_Term_$Impl_$;
...
jasper__$Term_Term_$Impl_$.multiplyValue = function(term,coefficient) {
	var this1 = new jasper__$Term_$(term.m_variable,term.m_coefficient * coefficient);
	return this1;
};
jasper__$Term_Term_$Impl_$.divideValue = function(term,denominator) {
	return jasper__$Term_Term_$Impl_$.multiplyValue(term,1.0 / denominator);
};
jasper__$Term_Term_$Impl_$.negateTerm = function(term) {
	return jasper__$Term_Term_$Impl_$.multiplyValue(term,-1.0);
};
jasper__$Term_Term_$Impl_$.addTerm = function(first,second) {
	var terms = [];
	terms.push(first);
	terms.push(second);
	var this1 = new jasper__$Expression_$(terms,0.0);
	return this1;
};
jasper__$Term_Term_$Impl_$.addVariable = function(term,variable) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Term_Term_$Impl_$.addTerm(term,this1);
};
jasper__$Term_Term_$Impl_$.addValue = function(term,constant) {
	var this1 = new jasper__$Expression_$([term],constant);
	return this1;
};
jasper__$Term_Term_$Impl_$.subtractExpression = function(term,expression) {
	return jasper__$Expression_Expression_$Impl_$.addTerm(jasper__$Expression_Expression_$Impl_$.negateExpression(expression),term);
};
jasper__$Term_Term_$Impl_$.subtractTerm = function(first,second) {
	return jasper__$Term_Term_$Impl_$.addTerm(first,jasper__$Term_Term_$Impl_$.negateTerm(second));
};
jasper__$Term_Term_$Impl_$.subtractVariable = function(term,variable) {
	return jasper__$Term_Term_$Impl_$.addTerm(term,jasper__$Variable_Variable_$Impl_$.negateVariable(variable));
};
jasper__$Term_Term_$Impl_$.subtractValue = function(term,constant) {
	return jasper__$Term_Term_$Impl_$.addValue(term,-constant);
};
jasper__$Term_Term_$Impl_$.equalsTerm = function(first,second) {
	var this1 = new jasper__$Expression_$([first],0.0);
	return jasper__$Expression_Expression_$Impl_$.equalsTerm(this1,second);
};
jasper__$Term_Term_$Impl_$.equalsVariable = function(term,variable) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.equalsVariable(this1,variable);
};
jasper__$Term_Term_$Impl_$.equalsValue = function(term,constant) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.equalsValue(this1,constant);
};
jasper__$Term_Term_$Impl_$.lteExpression = function(term,expression) {
	return jasper__$Expression_Expression_$Impl_$.gteTerm(expression,term);
};
jasper__$Term_Term_$Impl_$.lteTerm = function(first,second) {
	var this1 = new jasper__$Expression_$([first],0.0);
	return jasper__$Expression_Expression_$Impl_$.lteTerm(this1,second);
};
jasper__$Term_Term_$Impl_$.lteVariable = function(term,variable) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.lteVariable(this1,variable);
};
jasper__$Term_Term_$Impl_$.lteValue = function(term,constant) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.lteValue(this1,constant);
};
jasper__$Term_Term_$Impl_$.gteExpression = function(term,expression) {
	return jasper__$Expression_Expression_$Impl_$.lteTerm(expression,term);
};
jasper__$Term_Term_$Impl_$.gteTerm = function(first,second) {
	var this1 = new jasper__$Expression_$([first],0.0);
	return jasper__$Expression_Expression_$Impl_$.gteTerm(this1,second);
};
jasper__$Term_Term_$Impl_$.gteVariable = function(term,variable) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.gteVariable(this1,variable);
};
jasper__$Term_Term_$Impl_$.gteValue = function(term,constant) {
	var this1 = new jasper__$Expression_$([term],0.0);
	return jasper__$Expression_Expression_$Impl_$.gteValue(this1,constant);
};
var jasper_Util = function() { };
$hxClasses["jasper.Util"] = jasper_Util;
...
$hxClasses["jasper._Value.Value_Impl_"] = jasper__$Value_Value_$Impl_$;
jasper__$Value_Value_$Impl_$.__name__ = true;
jasper__$Value_Value_$Impl_$.subtractExpression = function(constant,expression) {
	return jasper__$Expression_Expression_$Impl_$.addValue(jasper__$Expression_Expression_$Impl_$.negateExpression(expression),constant);
};
jasper__$Value_Value_$Impl_$.subtractTerm = function(constant,term) {
	return jasper__$Term_Term_$Impl_$.addValue(jasper__$Term_Term_$Impl_$.negateTerm(term),constant);
};
jasper__$Value_Value_$Impl_$.subtractVariable = function(constant,variable) {
	return jasper__$Term_Term_$Impl_$.addValue(jasper__$Variable_Variable_$Impl_$.negateVariable(variable),constant);
};
jasper__$Value_Value_$Impl_$.lteExpression = function(constant,expression) {
	return jasper__$Expression_Expression_$Impl_$.gteValue(expression,constant);
};
jasper__$Value_Value_$Impl_$.lteTerm = function(constant,term) {
	return jasper__$Term_Term_$Impl_$.gteValue(term,constant);
};
jasper__$Value_Value_$Impl_$.lteVariable = function(constant,variable) {
	return jasper__$Variable_Variable_$Impl_$.gteValue(variable,constant);
};
jasper__$Value_Value_$Impl_$.gteExpression = function(constant,expression) {
	return jasper__$Expression_Expression_$Impl_$.lteValue(expression,constant);
};
jasper__$Value_Value_$Impl_$.gteTerm = function(constant,term) {
	return jasper__$Term_Term_$Impl_$.lteValue(term,constant);
};
jasper__$Value_Value_$Impl_$.gteVariable = function(constant,variable) {
	return jasper__$Variable_Variable_$Impl_$.lteValue(variable,constant);
};
var jasper__$Variable_$ = function(name) {
	this.m_name = name;
	this.m_value = 0.0;
};
...
jasper__$Variable_Variable_$Impl_$._new = function(name) {
	if(name == null) {
		name = "";
	}
...
jasper__$Variable_Variable_$Impl_$.divideValue = function(variable,denominator) {
	return jasper__$Variable_Variable_$Impl_$.multiplyValue(variable,1.0 / denominator);
};
jasper__$Variable_Variable_$Impl_$.negateVariable = function(variable) {
	return jasper__$Variable_Variable_$Impl_$.multiplyValue(variable,-1.0);
};
jasper__$Variable_Variable_$Impl_$.addVariable = function(first,second) {
	var this1 = new jasper__$Term_$(first,1.0);
	return jasper__$Term_Term_$Impl_$.addVariable(this1,second);
};
jasper__$Variable_Variable_$Impl_$.addValue = function(variable,constant) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Term_Term_$Impl_$.addValue(this1,constant);
};
jasper__$Variable_Variable_$Impl_$.subtractExpression = function(variable,expression) {
	var _g = variable;
	var _g1 = jasper__$Expression_Expression_$Impl_$.negateExpression(expression);
	return jasper__$Expression_Expression_$Impl_$.addVariable(_g1,_g);
};
jasper__$Variable_Variable_$Impl_$.subtractTerm = function(variable,term) {
	var _g = variable;
	var _g1 = jasper__$Term_Term_$Impl_$.negateTerm(term);
	return jasper__$Term_Term_$Impl_$.addVariable(_g1,_g);
};
jasper__$Variable_Variable_$Impl_$.subtractVariable = function(first,second) {
	var _g = first;
	var _g1 = jasper__$Variable_Variable_$Impl_$.negateVariable(second);
	return jasper__$Term_Term_$Impl_$.addVariable(_g1,_g);
};
jasper__$Variable_Variable_$Impl_$.subtractValue = function(variable,constant) {
	return jasper__$Variable_Variable_$Impl_$.addValue(variable,-constant);
};
jasper__$Variable_Variable_$Impl_$.equalsVariable = function(first,second) {
	var this1 = new jasper__$Term_$(first,1.0);
	return jasper__$Term_Term_$Impl_$.equalsVariable(this1,second);
};
jasper__$Variable_Variable_$Impl_$.equalsValue = function(variable,constant) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Term_Term_$Impl_$.equalsValue(this1,constant);
};
jasper__$Variable_Variable_$Impl_$.lteExpression = function(variable,expression) {
	return jasper__$Expression_Expression_$Impl_$.gteVariable(expression,variable);
};
jasper__$Variable_Variable_$Impl_$.lteTerm = function(variable,term) {
	return jasper__$Term_Term_$Impl_$.gteVariable(term,variable);
};
jasper__$Variable_Variable_$Impl_$.lteVariable = function(first,second) {
	var this1 = new jasper__$Term_$(first,1.0);
	return jasper__$Term_Term_$Impl_$.lteVariable(this1,second);
};
jasper__$Variable_Variable_$Impl_$.lteValue = function(variable,constant) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Term_Term_$Impl_$.lteValue(this1,constant);
};
jasper__$Variable_Variable_$Impl_$.gteExpression = function(variable,expression) {
	return jasper__$Expression_Expression_$Impl_$.lteVariable(expression,variable);
};
jasper__$Variable_Variable_$Impl_$.gteTerm = function(variable,term) {
	return jasper__$Term_Term_$Impl_$.lteVariable(term,variable);
};
jasper__$Variable_Variable_$Impl_$.gteVariable = function(first,second) {
	var this1 = new jasper__$Term_$(first,1.0);
	return jasper__$Term_Term_$Impl_$.gteVariable(this1,second);
};
jasper__$Variable_Variable_$Impl_$.gteValue = function(variable,constant) {
	var this1 = new jasper__$Term_$(variable,1.0);
	return jasper__$Term_Term_$Impl_$.gteValue(this1,constant);
};
var jasper_ds__$FloatMap_FloatMap_$Impl_$ = {};
$hxClasses["jasper.ds._FloatMap.FloatMap_Impl_"] = jasper_ds__$FloatMap_FloatMap_$Impl_$;
jasper_ds__$FloatMap_FloatMap_$Impl_$.__name__ = true;
jasper_ds__$FloatMap_FloatMap_$Impl_$._new = function() {
	var this1 = new jasper_ds_JasperMap();
	return this1;
};
jasper_ds__$FloatMap_FloatMap_$Impl_$.get = function(this1,key) {
	if(this1._map.exists(key)) {
		return this1._map.get(key);
	} else {
		return 0;
	}
};
jasper_ds__$FloatMap_FloatMap_$Impl_$.arrayWrite = function(this1,k,v) {
	if(!this1._map.exists(k)) {
		this1._keys.push(k);
	}
	this1._map.set(k,v);
...
var jasper_ds_JasperMap = function() {
	this._keys = [];
	this._map = new haxe_ds_ObjectMap();
};
$hxClasses["jasper.ds.JasperMap"] = jasper_ds_JasperMap;
jasper_ds_JasperMap.__name__ = true;
jasper_ds_JasperMap.__interfaces__ = [haxe_IMap];
jasper_ds_JasperMap.prototype = {
	empty: function() {
		return this._keys.length == 0;
	}
	,exists: function(key) {
		return this._map.h.__keys__[key.__id__] != null;
	}
	,get: function(key) {
		return this._map.h[key.__id__];
	}
	,iterator: function() {
		return new jasper_ds__$JasperMap_JasperIterator(this);
	}
	,keyValIterator: function() {
		return new jasper_ds__$JasperMap_KeyValIterator(this);
	}
	,keys: function() {
	...
	,set: function(key,value) {
		if(this._map.h.__keys__[key.__id__] == null) {
			this._keys.push(key);
		}
...
$hxClasses["jasper.ds._JasperMap.JasperIterator"] = jasper_ds__$JasperMap_JasperIterator;
jasper_ds__$JasperMap_JasperIterator.__name__ = true;
jasper_ds__$JasperMap_JasperIterator.prototype = {
	hasNext: function() {
		return this._index < this._map._keys.length;
	}
	,next: function() {
...
var jasper_ds__$JasperMap_KeyValIterator = function(map) {
	this._index = 0;
	this._map = map;
	this._item = { first : null, second : null};
};
$hxClasses["jasper.ds._JasperMap.KeyValIterator"] = jasper_ds__$JasperMap_KeyValIterator;
jasper_ds__$JasperMap_KeyValIterator.__name__ = true;
jasper_ds__$JasperMap_KeyValIterator.prototype = {
	hasNext: function() {
		return this._index < this._map._keys.length;
	}
	,next: function() {
		this._item.first = this._map._keys[this._index++];
		var tmp = this._map._map.get(this._item.first);
...
$hxClasses["jasper.ds._SolverMap.SolverMap_Impl_"] = jasper_ds__$SolverMap_SolverMap_$Impl_$;
jasper_ds__$SolverMap_SolverMap_$Impl_$.__name__ = true;
jasper_ds__$SolverMap_SolverMap_$Impl_$._new = function() {
	var this1 = new jasper_ds_JasperMap();
	return this1;
};
...
jasper__$Strength_Strength_$Impl_$.WEAK = 1;
jasper_Symbol.SYM_INVALID = 0;
jasper_Util.EPS = 1.0e-8;
jasper_Util.FLOAT_MAX = 1.79769313486231e+308;
